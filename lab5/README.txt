1. Implement Producer-Consumer Pattern in a bounded buffer using Semaphores. The bounded buffer of choice is a stack (std::stack). Make the buffer size (stack’s maximum capacity) not to exceed having 10000 elements inside. This is your shared data.
